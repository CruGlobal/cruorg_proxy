...
tests = {}
tests["'/level'{.*}"] = [location(`curl -s --head localhost/level2?purge_vanity`), '/level1/level2.html']
run_tests(tests)
redis.hdel('redirects:regex', "'/level'{.*}")

# with caching the previous test should work even with the redis key deleted
tests = {}
tests["'/level'{.*} - target cache"] = [location(`curl -s --head localhost/level2`), '/level1/level2.html']
run_tests(tests)

# with purge_vanity parameter, it should return a 404
tests = {}
tests["'/level'{.*} - cache purge"] = [location(`curl -s --head localhost/level2?purge_vanity`), 'no-cache']
run_tests(tests)
...
tests = {}
tests['/level1.html'] = [`curl -s localhost/level1.html?purge_target`.strip, 'level1']
tests['/level1/level2.html'] = [`curl -s localhost/level1/level2.html?purge_target`.strip, 'level2']
tests['/level1/level2/level3.html'] = [`curl -s localhost/level1/level2/level3.html?purge_target`.strip, 'level3']
tests['/level1/level2/level3/level4.html'] = [`curl -s localhost/level1/level2/level3/level4.html?purge_target`.strip, 'level4']
run_tests(tests)
...
tests = {}
tests['/level1.html'] = [`curl -s localhost/level1.html?purge_target`.strip, '404']
tests['/level1/level2.html'] = [`curl -s localhost/level1/level2.html?purge_target`.strip, 'level2']
tests['/level1/level2/level3.html'] = [`curl -s localhost/level1/level2/level3.html?purge_target`.strip, 'level3']
tests['/level1/level2/level3/level4.html'] = [`curl -s localhost/level1/level2/level3/level4.html?purge_target`.strip, 'level4']
run_tests(tests)
...
tests = {}
tests['/level1.html'] = [`curl -s localhost/level1.html?purge_target`.strip, '404']
tests['/level1/level2.html'] = [`curl -s localhost/level1/level2.html?purge_target`.strip, '404']
tests['/level1/level2/level3.html'] = [`curl -s localhost/level1/level2/level3.html?purge_target`.strip, 'level3']
tests['/level1/level2/level3/level4.html'] = [`curl -s localhost/level1/level2/level3/level4.html?purge_target`.strip, 'level4']
run_tests(tests)
